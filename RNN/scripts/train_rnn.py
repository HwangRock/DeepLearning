...
from RNN.utils.text_prepro import buildVocab, load_nmt_data, load_nmt_pair_data, text_to_indices
...
def main():
    ...
    if params['task'] == "EN2DE":
        train_source_text, train_target_text = load_nmt_data('en', 'de', data_params['train_file'])
        seq=0;
        print("<eng>")
        for i in train_source_text:
            print(i)
            seq+=1
            if seq>10:
                break;
